...
public class BoundFunction extends BaseFunction {
    ...
    public BoundFunction(Context cx, Scriptable scope, Callable targetFunction,
        ...
        PropertyDescriptor throwing = new PropertyDescriptor(thrower, thrower,
                false, false, false);
    ...
    public Object call(Context cx, Scriptable scope, Scriptable thisObj,
            Object[] extraArgs) {
        return targetFunction.call(cx, scope, boundThis, concat(boundArgs,
                extraArgs));
    }
    ...
    public Scriptable construct(Context cx, Scriptable scope, Object[] extraArgs) {
        if (targetFunction instanceof Function) {
            return ((Function) targetFunction).construct(cx, scope, concat(
                    boundArgs, extraArgs));
        }
